...
// LEDs.
const LED_RED_PIN: Pin = Pin::P1_10;
const LED_WHITE_PIN: Pin = Pin::P1_10;

const LED_KERNEL_PIN: Pin = Pin::P1_10;
...
const _UART_TX_PIN: Pin = Pin::P1_11;
const _UART_RX_PIN: Pin = Pin::P1_12;

/// I2C pins for all of the sensors.
const I2C_SDA_PIN: Pin = Pin::P0_04;
const I2C_SCL_PIN: Pin = Pin::P0_05;
